...
async function daily() {
  const data = {
    ...
    gBannerTime: (await fetch(`http://api.wolframalpha.com/v2/query?appid=${tokenWolf}&input=february+20+2024&output=json&ip=138.199.21.39`)).json(),
    hBannerTime: (await fetch(`http://api.wolframalpha.com/v2/query?appid=${tokenWolf}&input=february+29+2024&output=json&ip=138.199.21.39`)).json(),
